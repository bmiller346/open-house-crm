...
export class InitWorkspaceAndUsers1640000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DO $$
      BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'workspaces_subscriptionplan_enum') THEN
    ...
    await queryRunner.query('CREATE UNIQUE INDEX IF NOT EXISTS "IDX_8259d8f7b7e8c3e0b1e9c5f1b3" ON "workspaces" ("slug")');
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          ...
          WHERE constraint_name = 'FK_workspace_users_workspace'
        ) THEN
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM information_schema.table_constraints 
          WHERE constraint_name = 'FK_workspace_users_user'
        ) THEN
          ALTER TABLE "workspace_users" 
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_policies WHERE policyname = 'workspace_isolation' AND tablename = 'workspaces'
        ) THEN
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_policies WHERE policyname = 'workspace_users_isolation' AND tablename = 'workspace_users'
        ) THEN
